...
if (route.params.post.includes('(1')) {
    ...
    for (let i=0; i<length; i++) {
        try {
            content = await $fetch(`https://raw.githubusercontent.com/jyhyun1008/blog-peachtart-nuxt/main/img/${route.params.post.split('(')[0]}(${i}:${length})-${route.params.category}.jpg`)
            srcUrl = `https://raw.githubusercontent.com/jyhyun1008/blog-peachtart-nuxt/main/img/${route.params.post.split('(')[0]}(${i}:${length})-${route.params.category}.jpg`
        } catch(e) {
            try {
                content = await $fetch(`https://raw.githubusercontent.com/jyhyun1008/blog-peachtart-nuxt/main/img/${route.params.post.split('(')[0]}(${i}:${length})-${route.params.category}.png`)
                srcUrl = `https://raw.githubusercontent.com/jyhyun1008/blog-peachtart-nuxt/main/img/${route.params.post.split('(')[0]}(${i}:${length})-${route.params.category}.png`
            } catch(e1) {
                content = await $fetch(`https://raw.githubusercontent.com/jyhyun1008/blog-peachtart-nuxt/main/img/${route.params.post.split('(')[0]}(${i}:${length})-${route.params.category}.webp`)
                srcUrl = `https://raw.githubusercontent.com/jyhyun1008/blog-peachtart-nuxt/main/img/${route.params.post.split('(')[0]}(${i}:${length})-${route.params.category}.webp`
            }
        }
    }
} else {
